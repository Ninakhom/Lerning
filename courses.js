...
function switchToPreferedCourse(event) {
  ...
  if (event.target.id === "DevelopFullstack") {
    window.location = "./courses/Devfull.html";
  }
  if (event.target.id === "Flutter") {
    window.location = "./courses/flutter.html";
  }
  if (event.target.id === "IOT") {
    window.location = "./courses/iot.html";
  }
}
